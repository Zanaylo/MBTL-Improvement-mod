...
{
	const float size = g_settings.fontSize;
	...
	snprintf(g_status, sizeof(g_status), "No .ttf font found in %s. Using the built in font, which looks "
		"blurry above 1080p. Set [Overlay] FontPath to a .ttf file.",
		directory.c_str());
